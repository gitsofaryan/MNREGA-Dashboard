...
router.get('/data/:stateName', async (req, res) => {
  try {
    ...
    const data = result.rows.map(row => ({
      ...
      Average_days_of_employment_provided_per_Household: row.avg_days_employment,
      Number_of_HHs_completed_100_Days_of_Wage_employment: row.hhs_completed_100_days,
      ...
      Total_No_of_Persondays_Generated_so_far: row.total_number_persondays_generated,
